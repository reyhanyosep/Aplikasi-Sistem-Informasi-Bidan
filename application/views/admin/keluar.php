              ...
              <tbody>
                ...
                ?>
                  <tr>
                    <td><?php echo $no++; ?></td>
                    <td>
                      <a href="" data-toggle="modal" data-target="#detailBarang<?php echo $klr->nama ?>"><?php echo $klr->nama; ?></a>
                    </td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          <label>Alamat</label>
          <input type="text" class="form-control" value="<?php echo $brng->alamat ?>" disabled>
        </div>
        <div class="form-group">
          <label>Nomor Telepon</label>
          <input type="text" class="form-control" value="<?php echo $brng->nomor ?>" disabled>
        </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-danger" data-dismiss="modal"><div class="fa fa-close"></div> Tutup</button>
      </div>
    </div>
  </div>
</div>
